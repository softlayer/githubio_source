---
title: "view_active_alarms.go"
description: "view_active_alarms.go"
date: "2017-11-23"
classes: 
...
func main() {
	...
	// The id of virtual server you want to get it active alarms
	guestId  := 26165877

	startDate, _ := time.Parse("2006-01-02 15:04:05 -0700 UTC", "2014-01-01 23:02:03 +0000 UTC")
	...
	// Retrieve all active alarms of virtual guest
	activeAlarms, err := virtualService.Id(guestId).GetMonitoringActiveAlarms(sl.Time(startDate), sl.Time(endDate))
	if err != nil {
		fmt.Printf("\n Unable to get active alarms\n - %s\n", err)
		return
	}
