---
title: "route_vlans.go"
description: "route_vlans.go"
date: "2017-11-23"
classes: 
...
func main() {
	...
	// and build an array in order to pass it to unbypassVlans() method. But take account that
	...
	// Call method unbypassVlans() in order to bypass all vlans into array
	unbypassErr := service.Id(gatewayId).UnbypassVlans(gatewayVlans)
	if unbypassErr != nil {
		fmt.Printf("\n Unable to route selected vlans:\n - %s\n", unbypassErr)
		return
	}

	fmt.Println("\n Selected Vlans were routed!!")
}
