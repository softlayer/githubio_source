---
title: "desactivate_agent.go"
description: "desactivate_agent.go"
date: "2017-11-23"
classes: 
...
func main() {
	...
	// Agent name you want to deactivate
	...
	result, err := monitoringService.Id(*monitoringAgent.Id).Deactivate()
	if err != nil {
		fmt.Printf("\n Unable to deactivate the agent\n - %s\n", err)
		return
	}
