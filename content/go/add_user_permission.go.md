---
title: "add_user_permission.go"
description: "add_user_permission.go"
date: "2017-11-23"
classes: 
...
This script shows how to add permissions to an user.
...
func main() {
	...
	/*
	Declare the permission you want to add.
	...
	*/
	...
	result, err := service.Id(userId).AddPortalPermission(&permission)
	if err != nil {
