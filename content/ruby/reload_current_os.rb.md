---
title: "reload_current_os.rb"
description: "reload_current_os.rb"
date: "2017-11-23"
classes: 
...
begin
  # Call the reloadCurrentOperatingSystemConfiguration method from SoftLayer_Virtual_Guest.
  server_ref = virtual_guest_service.object_with_id(server_id)
  result = server_ref.reloadCurrentOperatingSystemConfiguration
  p "The server was reload successfully: #{result}"

rescue StandardError => exception
  p "Unable to reload Virtual Server Instance: #{exception}"
end
