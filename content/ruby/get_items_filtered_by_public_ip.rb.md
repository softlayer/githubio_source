---
title: "get_items_filtered_by_public_ip.rb"
description: "get_items_filtered_by_public_ip.rb"
date: "2017-11-23"
classes: 
...
filter_data = "primaryIpAddress:#{public_ip} _objectType:SoftLayer_Hardware,"\
              'SoftLayer_Virtual_Guest,'\
              'SoftLayer_Network_Vlan_Firewall,'\
              'SoftLayer_Network_Application_Delivery_Controller'

begin
  # Display items as "Portal>Device List" filtered by Public IP
