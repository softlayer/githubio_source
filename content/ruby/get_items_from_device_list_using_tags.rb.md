---
title: "get_items_from_device_list_using_tags.rb"
description: "get_items_from_device_list_using_tags.rb"
date: "2017-11-23"
classes: 
...
```
# Get items from "Portal>Device List" according to tags as filter
#
...
filter_data = "tagReferences.tag.name:#{tag} "\
...
begin
  # Display items according to tag filtered:
