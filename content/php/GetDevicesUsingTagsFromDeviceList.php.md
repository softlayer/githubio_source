---
title: "GetDevicesUsingTagsFromDeviceList.php"
description: "GetDevicesUsingTagsFromDeviceList.php"
date: "2017-11-23"
classes: 
...
/**
 * Set the tag to filter the item list.
 */
$tag = 'mytag';
 ...
 */
$filterData = 'tagReferences.tag.name: '.$tag .
...
try {
    ...
    echo 'Unable to get the item list using tags: ' . $e->getMessage();
}
