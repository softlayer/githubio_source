---
title: "GetApiKeyForUsers.php"
description: "GetApiKeyForUsers.php"
date: "2017-11-23"
classes: 
...
for ($i = 0; $i <= sizeof($receiptUsers) - 1; $i++) {
    ...
    try {
        ...
        // Print the result
        print_r("The Api Key for user " . $receiptUsers[$i] -> username . " is: " . $result[0] ->  authenticationKey. "\n");
    } catch(Exception $e) {
        echo "Unable to get Api Key for ".$receiptUsers[$i] -> username .": " . $e -> getMessage() ."\n";
    }
}
