...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_Container_Product_Order_Software_Component_Virtual' >Datatype</a></li>
    </ul>
</div>
    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#endPointIpAddressIds" name=endPointIpAddressIds>endPointIpAddressIds</a></span>
            <div class='views-field-body'>array of ip address ids for which a license should be allocated for. </div>
