...
description: "A SoftLayer_Billing_Item_Network_LoadBalancer_VirtualIpAddress represents the [SoftLayer_Billing_Item]({{<ref 'reference... "
layout: "datatype"
tags:
    - "datatype"
    - "sldn"
...
## Description 
A SoftLayer_Billing_Item_Network_LoadBalancer_VirtualIpAddress represents the [SoftLayer_Billing_Item]({{<ref "reference/datatypes/SoftLayer_Billing_Item">}}) instance. 
