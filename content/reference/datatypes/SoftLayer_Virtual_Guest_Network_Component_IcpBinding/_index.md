...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='views-field-body'>The type of IP that this IP allocation id record references.  Set to PRIMARY for the first servic port.  </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
        ...
        <h2>Relational</h2>
            ...
            <div class='views-field-body'>The network component associated with this object. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
