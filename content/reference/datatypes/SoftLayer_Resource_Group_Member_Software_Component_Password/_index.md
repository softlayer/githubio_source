...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_Resource_Group_Member_Software_Component_Password' >Datatype</a></li>
    </ul>
</div>
...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        ...
        <h2>Relational</h2>
            ...
            <div class='views-field-body'>A resource group member's associated software component password. </div>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>unsignedLong</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#descendantMemberCount" name=descendantMemberCount>descendantMemberCount</a></span>
