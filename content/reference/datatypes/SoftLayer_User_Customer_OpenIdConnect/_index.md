    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#minimumPasswordLifeHours" name=minimumPasswordLifeHours>minimumPasswordLifeHours</a>
            </span>
            <div class='views-field-body'>The minimum number of hours that must pass between password resets. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>integer</p>
            </div>
