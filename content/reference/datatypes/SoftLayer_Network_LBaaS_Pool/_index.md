    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>dateTime</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#loadBalancingAlgorithm" name=loadBalancingAlgorithm>loadBalancingAlgorithm</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#protocolPort" name=protocolPort>protocolPort</a></span>
        ...
        <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#healthMonitor" name=healthMonitor>healthMonitor</a></span>
