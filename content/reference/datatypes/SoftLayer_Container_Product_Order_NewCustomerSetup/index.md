...
description: "This is the datatype that needs to be populated and sent to SoftLayer_Product_Order::placeOrder when linking a Bluemix a... "
layout: "datatype"
tags:
    - "datatype"
    - "sldn"
...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_Container_Product_Order_NewCustomerSetup' >Datatype</a></li>
    </ul>
</div>
...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#authorizationToken" name=authorizationToken>authorizationToken</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>boolean</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#externalAccountId" name=externalAccountId>externalAccountId</a></span>
            <div class='views-field-body'> </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#externalServiceProviderKey" name=externalServiceProviderKey>externalServiceProviderKey</a></span>
            <div class='views-field-body'> </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
        </div>
                <div class='prop-row views-row'>
