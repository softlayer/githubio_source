...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_Container_Product_Order_Gateway_Appliance_Upgrade' >Datatype</a></li>
    </ul>
</div>

## Description 
This is the datatype that needs to be populated and sent to SoftLayer_Product_Order::placeOrder. This datatype has everything required to upgrade a [SoftLayer_Network_Gateway]({{<ref "reference/datatypes/SoftLayer_Network_Gateway">}}). 
...
[gatewayId]: #gatewayid
#### [gatewayId]
Identifier for the [SoftLayer_Network_Gateway]({{<ref "reference/datatypes/SoftLayer_Network_Gateway">}}) being upgraded.  
<span class="type-label">Type: </span>**integer**
