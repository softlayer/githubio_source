    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#gatewayId" name=gatewayId>gatewayId</a>
            </span>
            <div class='views-field-body'>Identifier for the [[SoftLayer_Network_Gateway (type)|network gateway]] being upgraded. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>integer</p>
            </div>
