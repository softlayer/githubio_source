    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#billingCancelReasonId" name=billingCancelReasonId>billingCancelReasonId</a>
            </span>
...
It will be updated to "Complete" when all services are reclaimed.  </div>
        ...
        <h2>Relational</h2>
            ...
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Billing_Item_Cancellation_Request_Status'>SoftLayer_Billing_Item_Cancellation_Request_Status </a></p>
            </div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
