...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#destinationIp" name=destinationIp>destinationIp</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#hits" name=hits>hits</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>integer</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#loadBalanceOrder" name=loadBalanceOrder>loadBalanceOrder</a></span>
        ...
        <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#loadBalancerAccount" name=loadBalancerAccount>loadBalancerAccount</a></span>
