...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_User_Customer_MobileDevice' >Datatype</a></li>
    </ul>
</div>
    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>dateTime</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#displayResolutionXxY" name=displayResolutionXxY>displayResolutionXxY</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>integer</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#mobileDeviceTypeId" name=mobileDeviceTypeId>mobileDeviceTypeId</a></span>
            <div class='views-field-body'>Device type identifier. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>integer</p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#mobileOperatingSystemId" name=mobileOperatingSystemId>mobileOperatingSystemId</a></span>
            <div class='views-field-body'>Mobile OS identifier. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>integer</p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#modelNumber" name=modelNumber>modelNumber</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#phoneNumber" name=phoneNumber>phoneNumber</a></span>
        ...
        <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#availablePushNotificationSubscriptions" name=availablePushNotificationSubscriptions>availablePushNotificationSubscriptions</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_User_Customer_MobileDevice_OperatingSystem'>SoftLayer_User_Customer_MobileDevice_OperatingSystem </a></p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#pushNotificationSubscriptions" name=pushNotificationSubscriptions>pushNotificationSubscriptions</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_User_Customer_MobileDevice_Type'>SoftLayer_User_Customer_MobileDevice_Type </a></p></div>
        </div>
                <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#availablePushNotificationSubscriptionCount" name=availablePushNotificationSubscriptionCount>availablePushNotificationSubscriptionCount</a></span>
            <div class='views-field-body'>A count of notification subscriptions available to a mobile device. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>unsignedLong</p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#pushNotificationSubscriptionCount" name=pushNotificationSubscriptionCount>pushNotificationSubscriptionCount</a></span>
