    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#cosBucket" name=cosBucket>cosBucket</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth1Gateway" name=eth1Gateway>eth1Gateway</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth1IpAddress" name=eth1IpAddress>eth1IpAddress</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth3Gateway" name=eth3Gateway>eth3Gateway</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth3IpAddress" name=eth3IpAddress>eth3IpAddress</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#poolLockPassword" name=poolLockPassword>poolLockPassword</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#s3Url" name=s3Url>s3Url</a>
            </span>
            <div class='views-field-body'>The Cloud Object Storage bucket URL. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#shareName" name=shareName>shareName</a>
            </span>
        ...
        <h2>Relational</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#storageAccount" name=storageAccount>storageAccount</a>
            </span>
            <div class='views-field-body'>The storage account to use for this request. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Network_Storage_Hub_Cleversafe_Account'>SoftLayer_Network_Storage_Hub_Cleversafe_Account </a></p>
            </div>
        </div>
                <h2>Count</h2>
            </div>
