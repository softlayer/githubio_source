...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#accountNoteId" name=accountNoteId>accountNoteId</a></span>
        ...
        <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#accountNote" name=accountNote>accountNote</a></span>
            <div class='views-field-body'> </div>
