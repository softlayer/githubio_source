    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#typeParentId" name=typeParentId>typeParentId</a>
            </span>
        ...
        <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#hardwareGenericComponentModels" name=hardwareGenericComponentModels>hardwareGenericComponentModels</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#typeParent" name=typeParent>typeParent</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#hardwareGenericComponentModelCount" name=hardwareGenericComponentModelCount>hardwareGenericComponentModelCount</a>
            </span>
