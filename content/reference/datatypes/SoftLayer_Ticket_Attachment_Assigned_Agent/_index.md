...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#assignedAgentId" name=assignedAgentId>assignedAgentId</a></span>
            <div class='views-field-body'>The internal identifier of an assigned Agent that is attached to a ticket. </div>
        ...
        <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#assignedAgent" name=assignedAgent>assignedAgent</a></span>
