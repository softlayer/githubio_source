...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#associatedInvoiceItemId" name=associatedInvoiceItemId>associatedInvoiceItemId</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>integer</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#productItemId" name=productItemId>productItemId</a></span>
        ...
        <h2>Relational</h2>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_Billing_Invoice_Item'>SoftLayer_Billing_Invoice_Item[] </a></p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#associatedInvoiceItem" name=associatedInvoiceItem>associatedInvoiceItem</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_Billing_Invoice_Item'>SoftLayer_Billing_Invoice_Item[] </a></p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#filteredAssociatedChildren" name=filteredAssociatedChildren>filteredAssociatedChildren</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_Location'>SoftLayer_Location </a></p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#nonZeroAssociatedChildren" name=nonZeroAssociatedChildren>nonZeroAssociatedChildren</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_Product_Item'>SoftLayer_Product_Item </a></p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#topLevelProductGroupName" name=topLevelProductGroupName>topLevelProductGroupName</a></span>
            <div class='views-field-body'>A string representing the name of parent level product group of an invoice item. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#totalOneTimeAmount" name=totalOneTimeAmount>totalOneTimeAmount</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>float</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#totalOneTimeTaxAmount" name=totalOneTimeTaxAmount>totalOneTimeTaxAmount</a></span>
            <div class='views-field-body'>An invoice Item's total, including any child invoice items if they exist. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>float</p></div>
        </div>
                <div class='prop-row views-row'>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>float</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#totalRecurringTaxAmount" name=totalRecurringTaxAmount>totalRecurringTaxAmount</a></span>
