...
description: "The SoftLayer_Software_Component_HostIps_Mcafee_Epo_Version36_Hips_Version6 data type represents a single McAfee Secure... "
layout: "datatype"
tags:
    - "datatype"
    - "sldn"
...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_Software_Component_HostIps_Mcafee_Epo_Version36_Hips_Version6' >Datatype</a></li>
    </ul>
</div>
...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        ...
        <h2>Relational</h2>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>McAfee_Epolicy_Orchestrator_Version36_Hips_Version6_BlockedApplicationEvent[]</p></div>
        </div>
                <div class='prop-row views-row'>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>McAfee_Epolicy_Orchestrator_Version36_Hips_Version6_IPSEvent[]</p></div>
        </div>
                <div class='prop-row views-row'>
