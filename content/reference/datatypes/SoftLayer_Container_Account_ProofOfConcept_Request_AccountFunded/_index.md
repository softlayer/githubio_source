    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#costRecoveryRequest" name=costRecoveryRequest>costRecoveryRequest</a>
            </span>
            <div class='views-field-body'>Billing codes for the department paying for the proof of concept account </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
