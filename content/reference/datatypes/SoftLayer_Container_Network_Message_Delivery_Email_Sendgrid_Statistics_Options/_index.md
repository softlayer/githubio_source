...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#aggregatesOnly" name=aggregatesOnly>aggregatesOnly</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#days" name=days>days</a></span>
            <div class='views-field-body'> </div>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>dateTime</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#selectedStatistics" name=selectedStatistics>selectedStatistics</a></span>
            <div class='views-field-body'> </div>
