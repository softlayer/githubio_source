...
[userId]: #userid
#### [userId]
The SoftLayer [SoftLayer_User_Customer]({{<ref "reference/datatypes/SoftLayer_User_Customer">}}) identifier that an external binding is being purchased for.  
<span class="type-label">Type: </span>**integer**

-----
[vendorId]: #vendorid
#### [vendorId]
The [SoftLayer_User_Customer_External_Binding_Vendor]({{<ref "reference/datatypes/SoftLayer_User_Customer_External_Binding_Vendor">}}) identifier for the external binding being purchased.  
<span class="type-label">Type: </span>**integer**
