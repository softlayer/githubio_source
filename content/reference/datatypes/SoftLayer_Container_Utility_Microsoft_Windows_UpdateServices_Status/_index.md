...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#lastRebootDate" name=lastRebootDate>lastRebootDate</a></span>
            <div class='views-field-body'>The last time a server rebooted due to a Windows Update. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>dateTime</p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#lastStatusDate" name=lastStatusDate>lastStatusDate</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>dateTime</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#lastSyncDate" name=lastSyncDate>lastSyncDate</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#syncStatus" name=syncStatus>syncStatus</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#updateStatus" name=updateStatus>updateStatus</a></span>
