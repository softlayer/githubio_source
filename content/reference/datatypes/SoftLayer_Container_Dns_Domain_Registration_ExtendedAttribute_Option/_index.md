    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#requireExtendedAttributes" name=requireExtendedAttributes>requireExtendedAttributes</a>
            </span>
            <div class='views-field-body'>Extended Attribute that is required for an option. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Container_Dns_Domain_Registration_ExtendedAttribute_Option_Require'>SoftLayer_Container_Dns_Domain_Registration_ExtendedAttribute_Option_Require[] </a></p>
            </div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
