...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='views-field-body'>The short description of a cancellation request status </div>
            ...
            <div class='views-field-body'>The internal identifier of a cancellation request status. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>integer</p>
            </div>
            ...
            <div class='views-field-body'>status key name </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
