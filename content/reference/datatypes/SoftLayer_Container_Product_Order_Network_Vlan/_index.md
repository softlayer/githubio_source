...
-----
[hostnameDatacenter]: #hostnamedatacenter
#### [hostnameDatacenter]
...
[routerId]: #routerid
#### [routerId]
The ID of the [SoftLayer_Hardware_Router]({{<ref "reference/datatypes/SoftLayer_Hardware_Router">}}) object on which the new VLAN should be created.  
<span class="type-label">Type: </span>**integer**
