...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#customerId" name=customerId>customerId</a></span>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p>dateTime</p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#transcript" name=transcript>transcript</a></span>
            <div class='views-field-body'> </div>
        ...
        <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#agent" name=agent>agent</a></span>
            <div class='views-field-body'> </div>
            ...
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_User_Customer'>SoftLayer_User_Customer </a></p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#ticketUpdate" name=ticketUpdate>ticketUpdate</a></span>
            <div class='views-field-body'> </div>
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_Ticket_Update_Chat'>SoftLayer_Ticket_Update_Chat </a></p></div>
        </div>
                <h2>Relational</h2>
            </div>
</div>
