...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        ...
        <h2>Relational</h2>
            ...
            <div class='views-field-body'>The firewall's primary public IP address. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
        </div>
                <div class='prop-row views-row'>
            ...
            <div class='views-field-body'>A list of users that have access to this hardware firewall. </div>
            ...
            <div class='views-field-body'>A count of a list of users that have access to this hardware firewall. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>unsignedLong</p></div>
        </div>
                <div class='prop-row views-row'>
