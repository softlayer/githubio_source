...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='views-field-body'>A brief description of a SoftLayer account attribute type.  </div>
            ...
            <div class='views-field-body'>A SoftLayer account attribute type's internal identifier.  </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>integer</p>
            </div>
            ...
            <div class='views-field-body'>A SoftLayer account attribute type's key name. This is typically a shorter version of an attribute type's name.  </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
            ...
            <div class='views-field-body'>A SoftLayer account attribute type's name.  </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
