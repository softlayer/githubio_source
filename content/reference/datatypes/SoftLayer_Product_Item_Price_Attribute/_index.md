    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#itemPriceAttributeTypeId" name=itemPriceAttributeTypeId>itemPriceAttributeTypeId</a>
            </span>
            <div class='views-field-body'> </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
        ...
        <h2>Relational</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#itemPriceAttributeType" name=itemPriceAttributeType>itemPriceAttributeType</a>
            </span>
            <div class='views-field-body'> </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Product_Item_Price_Attribute_Type'>SoftLayer_Product_Item_Price_Attribute_Type </a></p>
            </div>
        </div>
                <h2>Count</h2>
            </div>
