    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'>
                <a href="#approvalOrder" name=approvalOrder>approvalOrder</a>
            </span>
            <div class='views-field-body'>Approval slot of the approver. </div>
            ...
            <div class='views-field-body'>First name of the approver. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
            ...
            <div class='views-field-body'>Internal identifier of a Proof of Concept account approver. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>integer</p>
            </div>
            ...
            <div class='views-field-body'>Last name of the approver. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
            ...
            <div class='views-field-body'>SoftLayer_Account_ProofOfConcept_Approver_Region identifier of the approver. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
            ...
            <div class='views-field-body'>SoftLayer_Account_ProofOfConcept_Approver_Role identifier of the approver. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>integer</p>
            </div>
            ...
            <div class='views-field-body'>SoftLayer_Account_ProofOfConcept_Approver_Type identifier of the approver. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>integer</p>
            </div>
        ...
        <h2>Relational</h2>
            ...
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Account_ProofOfConcept_Approver_Role'>SoftLayer_Account_ProofOfConcept_Approver_Role </a></p>
            </div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
