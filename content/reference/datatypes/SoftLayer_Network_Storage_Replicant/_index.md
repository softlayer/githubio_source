...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        ...
        <h2>Relational</h2>
            ...
            <div class='views-field-body'>The current billing item for this network storage replicant volume. </div>
            ...
            <div class='views-field-body'>The permissions groups this replicant volume is in. </div>
            ...
            <div class='views-field-body'>The volume name for a replicant. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
        </div>
                <div class='prop-row views-row'>
            ...
            <div class='views-field-body'>A count of the permissions groups this replicant volume is in. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>unsignedLong</p></div>
        </div>
                <div class='prop-row views-row'>
