---
title: "SoftLayer_Metric_Tracking_Object_Data_Network_ContentDelivery_Account"
description: "SoftLayer_Metric_Tracking_Object_Data_Network_ContentDelivery_Account models usage data polled from the CDN system."
layout: "datatype"
tags:
    - "datatype"
    - "sldn"
...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_Metric_Tracking_Object_Data_Network_ContentDelivery_Account' >Datatype</a></li>
    </ul>
</div>
...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='views-field-body'>The name of a file. This value is only populated in file-based bandwidth reports.  </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#popId" name=popId>popId</a></span>
            <div class='views-field-body'>The internal identifier of a CDN POP (Points of Presence).  </div>
