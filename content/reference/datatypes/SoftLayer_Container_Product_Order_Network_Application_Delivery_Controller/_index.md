...
-----
[applicationDeliveryControllerId]: #applicationdeliverycontrollerid
#### [applicationDeliveryControllerId]
An optional [SoftLayer_Network_Application_Delivery_Controller]({{<ref "reference/datatypes/SoftLayer_Network_Application_Delivery_Controller">}}) identifier that is used for upgrading an existing application delivery controller.   
