...
-----
[duplicateOriginSnapshotId]: #duplicateoriginsnapshotid
#### [duplicateOriginSnapshotId]
This must be populated only for duplicating a specific snapshot for volume duplicating. It represents the identifier of the origin [SoftLayer_Network_Storage_Snapshot]({{<ref "reference/datatypes/SoftLayer_Network_Storage_Snapshot">}})   
<span class="type-label">Type: </span>**integer**

-----
[duplicateOriginVolumeId]: #duplicateoriginvolumeid
#### [duplicateOriginVolumeId]
This must be populated only for duplicate volume ordering. It represents the identifier of the origin [SoftLayer_Network_Storage]({{<ref "reference/datatypes/SoftLayer_Network_Storage">}}).   
<span class="type-label">Type: </span>**integer**
...
[iops]: #iops
#### [iops]
When upgrading performance by IOPS, populate this property with how many.  
<span class="type-label">Type: </span>**integer**

-----
[isDependentDuplicateFlag]: #isdependentduplicateflag
...
#### [originVolumeId]
This must be populated only for replicant volume ordering. It represents the identifier of the origin [SoftLayer_Network_Storage]({{<ref "reference/datatypes/SoftLayer_Network_Storage">}}).   
<span class="type-label">Type: </span>**integer**

-----
[originVolumeScheduleId]: #originvolumescheduleid
#### [originVolumeScheduleId]
This must be populated only for replicant volume ordering. It represents the [SoftLayer_Network_Storage_Schedule]({{<ref "reference/datatypes/SoftLayer_Network_Storage_Schedule">}}) that will be be used to replicate the origin [SoftLayer_Network_Storage]({{<ref "reference/datatypes/SoftLayer_Network_Storage">}}) volume.   
<span class="type-label">Type: </span>**integer**
...
[volume]: #volume
#### [volume]
The [SoftLayer_Network_Storage]({{<ref "reference/datatypes/SoftLayer_Network_Storage">}}) being upgraded. Only it's ID is required.   
<span class="type-label">Type: </span>**<a href='/reference/datatypes/SoftLayer_Network_Storage'>SoftLayer_Network_Storage </a>**

-----
[volumeSize]: #volumesize
#### [volumeSize]
Size in GBs that the volume will be upgraded to. Leave empty when the volume size is not to be upgraded.   
<span class="type-label">Type: </span>**integer**
