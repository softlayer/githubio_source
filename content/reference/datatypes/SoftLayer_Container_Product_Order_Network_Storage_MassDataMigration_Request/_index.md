    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#cosAccountId" name=cosAccountId>cosAccountId</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#cosBucketName" name=cosBucketName>cosBucketName</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth1DefaultGateway" name=eth1DefaultGateway>eth1DefaultGateway</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth1Netmask" name=eth1Netmask>eth1Netmask</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth1StaticIp" name=eth1StaticIp>eth1StaticIp</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth3Netmask" name=eth3Netmask>eth3Netmask</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#eth3StaticIp" name=eth3StaticIp>eth3StaticIp</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#keyContactEmails" name=keyContactEmails>keyContactEmails</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#keyContactNames" name=keyContactNames>keyContactNames</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#keyContactPhoneNumbers" name=keyContactPhoneNumbers>keyContactPhoneNumbers</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#keyContactRoles" name=keyContactRoles>keyContactRoles</a>
            </span>
...
If a regional group is provided and VLANs are specified (within the <code>hardware</code> or <code>virtualGuests</code> properties), we will use the datacenter where the VLANs are located. If no VLANs are specified, we will use the preferred datacenter on the regional group object.  </div>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#requestName" name=requestName>requestName</a>
            </span>
            ...
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Container_Network_Storage_MassDataMigration_Request_Address'>SoftLayer_Container_Network_Storage_MassDataMigration_Request_Address </a></p>
            </div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
