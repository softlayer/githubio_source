    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#firewallTemplateId" name=firewallTemplateId>firewallTemplateId</a>
            </span>
        ...
        <h2>Relational</h2>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#firewallTemplate" name=firewallTemplate>firewallTemplate</a>
            </span>
            <div class='views-field-body'>The firewall template that this rule is attached to. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Network_Firewall_Template'>SoftLayer_Network_Firewall_Template </a></p>
            </div>
        </div>
                <h2>Count</h2>
            </div>
