    ...
    <div id="localProperties" class="prop-content" >
        ...
        <h2>Relational</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#agentStatuses" name=agentStatuses>agentStatuses</a>
            </span>
            ...
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Container_Network_Storage_Evault_WebCc_AgentStatus'>SoftLayer_Container_Network_Storage_Evault_WebCc_AgentStatus[] </a></p>
            </div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#backupJobDetails" name=backupJobDetails>backupJobDetails</a>
            </span>
            <div class='views-field-body'>All the of the backup jobs for the EVault Storage account. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Container_Network_Storage_Evault_WebCc_JobDetails'>SoftLayer_Container_Network_Storage_Evault_WebCc_JobDetails[] </a></p>
            </div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#currentCyclePeakUsage" name=currentCyclePeakUsage>currentCyclePeakUsage</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#pluginBillingItems" name=pluginBillingItems>pluginBillingItems</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#previousCyclePeakUsage" name=previousCyclePeakUsage>previousCyclePeakUsage</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#restoreJobDetails" name=restoreJobDetails>restoreJobDetails</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#tasks" name=tasks>tasks</a>
            </span>
            <div class='views-field-body'>Retrieve the task information for the EVault Storage service. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Container_Network_Storage_Evault_Vault_Task'>SoftLayer_Container_Network_Storage_Evault_Vault_Task[] </a></p>
            </div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#agentStatusCount" name=agentStatusCount>agentStatusCount</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#backupJobDetailCount" name=backupJobDetailCount>backupJobDetailCount</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#pluginBillingItemCount" name=pluginBillingItemCount>pluginBillingItemCount</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#restoreJobDetailCount" name=restoreJobDetailCount>restoreJobDetailCount</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#taskCount" name=taskCount>taskCount</a>
            </span>
