...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#policy" name=policy>policy</a></span>
            <div class='views-field-body'>The value of a host ips category. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>string</p></div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#policyTitle" name=policyTitle>policyTitle</a></span>
