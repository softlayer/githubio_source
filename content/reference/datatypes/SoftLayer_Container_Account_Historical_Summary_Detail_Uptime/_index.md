...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <span class='views-field-title'><a href="#cloudComputingInstance" name=cloudComputingInstance>cloudComputingInstance</a></span>
            <div class='views-field-body'>The hardware for uptime details. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p><a href='/reference/datatypes/SoftLayer_Virtual_Guest'>SoftLayer_Virtual_Guest </a></p></div>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'><a href="#configurationValue" name=configurationValue>configurationValue</a></span>
            <div class='views-field-body'>The configuration value for the detail's resource. </div>
            ...
            <div class='views-field-body'>The data associated with a host uptime details. </div>
            ...
            <div class='views-field-body'>The maximum date included in the detail. </div>
            ...
            <div class='views-field-body'>The minimum date included in the detail. </div>
            <span class="type-label">Type:</span> <div class='type-content'><p>dateTime</p></div>
        </div>
            </div>
    </div>
