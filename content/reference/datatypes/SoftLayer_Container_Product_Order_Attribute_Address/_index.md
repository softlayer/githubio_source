    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#nonUsState" name=nonUsState>nonUsState</a>
            </span>
            <div class='views-field-body'>State, Region or Province not part of the U.S. or Canada. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
            ...
            <div class='views-field-body'>U.S. State, Region or Canadian Province. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
