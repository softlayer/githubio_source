...
<div id="properties" class="content">
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='views-field-body'>Identifier of [[SoftLayer_Hardware_Router]] on which the capacity will be </div>
            ...
            <div class='views-field-body'>Name for the [[SoftLayer_Virtual_ReservedCapacityGroup]] being ordered. </div>
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p>string</p>
            </div>
