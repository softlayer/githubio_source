...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_Container_Product_Order_Virtual_ReservedCapacity' >Datatype</a></li>
    </ul>
</div>
...
#### [backendRouterId]
Identifier of [SoftLayer_Hardware_Router]({{<ref "reference/datatypes/SoftLayer_Hardware_Router">}}) on which the capacity will be  
...
[name]: #name
#### [name]
Name for the [SoftLayer_Virtual_ReservedCapacityGroup]({{<ref "reference/datatypes/SoftLayer_Virtual_ReservedCapacityGroup">}}) being ordered.  
<span class="type-label">Type: </span>**string**
