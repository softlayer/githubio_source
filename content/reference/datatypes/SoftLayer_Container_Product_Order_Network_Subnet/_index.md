...
-----
[endPointIpAddressId]: #endpointipaddressid
#### [endPointIpAddressId]
The [SoftLayer_Network_Subnet_IpAddress]({{<ref "reference/datatypes/SoftLayer_Network_Subnet_IpAddress">}}) id.  
<span class="type-label">Type: </span>**integer**

-----
[endPointVlanId]: #endpointvlanid
#### [endPointVlanId]
The [SoftLayer_Network_Vlan]({{<ref "reference/datatypes/SoftLayer_Network_Vlan">}}) id.  
<span class="type-label">Type: </span>**integer**
...
[id]: #id
#### [id]
The [SoftLayer_Network_Subnet]({{<ref "reference/datatypes/SoftLayer_Network_Subnet">}}) id.  
<span class="type-label">Type: </span>**integer**
...
#### [routerHostname]
This is the hostname for the router associated with the [SoftLayer_Network_Subnet]({{<ref "reference/datatypes/SoftLayer_Network_Subnet">}}). This is a readonly property.   
<span class="type-label">Type: </span>**string**
