    ...
    <div id="localProperties" class="prop-content" >
        <h2>Local</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#groupTypeId" name=groupTypeId>groupTypeId</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#serviceResourceId" name=serviceResourceId>serviceResourceId</a>
            </span>
        ...
        <h2>Relational</h2>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#allowedHosts" name=allowedHosts>allowedHosts</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#attachedVolumes" name=attachedVolumes>attachedVolumes</a>
            </span>
            ...
            <span class="type-label">Type:</span> 
            <div class='type-content'>
                <p><a href='/reference/datatypes/SoftLayer_Network_Storage_Group_Type'>SoftLayer_Network_Storage_Group_Type </a></p>
            </div>
        </div>
                <div class='prop-row views-row'>
            <span class='views-field-title'>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#allowedHostCount" name=allowedHostCount>allowedHostCount</a>
            </span>
            ...
            <div class='type-content'>
                ...
                <div class='prop-row views-row'>
            <span class='views-field-title'>
                <a href="#attachedVolumeCount" name=attachedVolumeCount>attachedVolumeCount</a>
            </span>
