...
#### [interconnectId]
The [SoftLayer_Network_Interconnect]({{<ref "reference/datatypes/SoftLayer_Network_Interconnect">}}) for this order, ID must be provided.  
<span class="type-label">Type: </span>**integer**

-----
[interconnectLocation]: #interconnectlocation
#### [interconnectLocation]
The [SoftLayer_Network_DirectLink_Location]({{<ref "reference/datatypes/SoftLayer_Network_DirectLink_Location">}}) for this order, ID must be provided.  
<span class="type-label">Type: </span>**<a href='/reference/datatypes/SoftLayer_Network_DirectLink_Location'>SoftLayer_Network_DirectLink_Location </a>**

-----
[interconnectTenant]: #interconnecttenant
#### [interconnectTenant]
The [SoftLayer_Network_Interconnect_Tenant]({{<ref "reference/datatypes/SoftLayer_Network_Interconnect_Tenant">}}) being ordered. Only the ID is required. If this ID is specified, then properties such as networkIdentifier, ipAddressRange, and interconnectId do not need to be specified.   
<span class="type-label">Type: </span>**<a href='/reference/datatypes/SoftLayer_Network_Interconnect_Tenant'>SoftLayer_Network_Interconnect_Tenant </a>**
