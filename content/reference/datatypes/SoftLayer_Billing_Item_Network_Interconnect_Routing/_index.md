...
description: "A SoftLayer_Billing_Item_Network_Interconnect_Routing represents the [SoftLayer_Billing_Item]({{<ref 'reference/datatype... "
layout: "datatype"
tags:
    - "datatype"
    - "sldn"
...
<div id='service-datatype'>
    <ul id='sldn-reference-tabs'>
        <li id='datatype'> <a href='/reference/datatypes/SoftLayer_Billing_Item_Network_Interconnect_Routing' >Datatype</a></li>
    </ul>
</div>

## Description 
A SoftLayer_Billing_Item_Network_Interconnect_Routing represents the [SoftLayer_Billing_Item]({{<ref "reference/datatypes/SoftLayer_Billing_Item">}}) related to a network interconnect global routing. 
