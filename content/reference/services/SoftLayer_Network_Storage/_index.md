...
#### [getAllowDisasterRecoveryFailback](/reference/services/SoftLayer_Network_Storage/getAllowDisasterRecoveryFailback)

</div>

<div class="method-row">

#### [getAllowDisasterRecoveryFailover](/reference/services/SoftLayer_Network_Storage/getAllowDisasterRecoveryFailover)
...
#### [getFailoverNotAllowed](/reference/services/SoftLayer_Network_Storage/getFailoverNotAllowed)
...
#### [getIsInDedicatedServiceResource](/reference/services/SoftLayer_Network_Storage/getIsInDedicatedServiceResource)

</div>

<div class="method-row">

#### [getIsMagneticStorage](/reference/services/SoftLayer_Network_Storage/getIsMagneticStorage)
...
#### [getMountPath](/reference/services/SoftLayer_Network_Storage/getMountPath)
...
#### [getNetworkMountPath](/reference/services/SoftLayer_Network_Storage/getNetworkMountPath)
Displays the mount path of a storage volume.
</div>
