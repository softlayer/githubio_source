...
description: "SOAP API will list modify response headers for an existing mapping and for a particular customer. "
date: "2018-02-12"
tags:
    - "method"
    - "sldn"
...
### [REST Example](#listModifyResponseHeader-example) <a href="/article/rest/"><i class="fas fa-question"></i></a> {#listModifyResponseHeader-example .anchor-link} 
```bash
