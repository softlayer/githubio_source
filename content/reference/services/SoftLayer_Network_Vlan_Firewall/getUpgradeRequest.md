...
description: "A firewall's associated upgrade request object, if any."
date: "2018-02-12"
tags:
    - "method"
    - "sldn"
...
'https://api.softlayer.com/rest/v3.1/SoftLayer_Network_Vlan_Firewall/{SoftLayer_Network_Vlan_FirewallID}/getUpgradeRequest'
```
