...
### [REST Example](#removeDedicatedHostAccess-example) <a href="/article/rest/"><i class="fas fa-question"></i></a> {#removeDedicatedHostAccess-example .anchor-link} 
```bash
curl -g -u $SL_USER:$SL_APIKEY -X POST -d '{"parameters": [int]}' \
'https://api.softlayer.com/rest/v3.1/SoftLayer_User_Customer_OpenIdConnect_TrustedProfile/{SoftLayer_User_Customer_OpenIdConnect_TrustedProfileID}/removeDedicatedHostAccess'
```
