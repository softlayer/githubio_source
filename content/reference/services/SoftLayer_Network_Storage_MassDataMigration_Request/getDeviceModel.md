...
description: "The model of device assigned to this request."
date: "2018-02-12"
tags:
    - "method"
    - "sldn"
...
# [REST Example](#getDeviceModel-example) <a href="/article/rest/"><i class="fas fa-question"></i></a> {#getDeviceModel-example .anchor-link} 
```bash
