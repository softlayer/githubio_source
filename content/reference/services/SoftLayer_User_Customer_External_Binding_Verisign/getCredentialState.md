...
description: "Retrieve the current state of a VeriSign credential. This can be 'Enabled', 'Disabled', or 'Locked'."
layout: "method"
tags:
    - "method"
    - "sldn"
...
aliases:
    - "/reference/services/softlayer_user_customer_external_binding_verisign/getCredentialState"
---
