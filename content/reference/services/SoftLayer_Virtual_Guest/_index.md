...
<div id="properties" class="content">
    ...
    <div id="method-div">
            ...
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_Virtual_Guest/getGpuCount'> getGpuCount</a> </span>
            <div class='views-field-body'>Retrieve the number of GPUs attached to the guest.</div>
        </div>
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_Virtual_Guest/getGpuType'> getGpuType</a> </span>
            <div class='views-field-body'>Retrieve the name of the GPU type attached to the guest.</div>
        </div>
            <div class="method-row">
            ...
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_Virtual_Guest/getPendingMaintenanceActions'> getPendingMaintenanceActions</a> </span>
            <div class='views-field-body'>Returns a list of all the pending maintenance actions affecting this guest. </div>
        </div>
            <div class="method-row">
