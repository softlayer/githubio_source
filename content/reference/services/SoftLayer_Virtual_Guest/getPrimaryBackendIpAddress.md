...
description: "A guest's primary private IP address."
date: "2018-02-12"
tags:
    - "method"
    - "sldn"
...
'https://api.softlayer.com/rest/v3.1/SoftLayer_Virtual_Guest/{SoftLayer_Virtual_GuestID}/getPrimaryBackendIpAddress'
```
