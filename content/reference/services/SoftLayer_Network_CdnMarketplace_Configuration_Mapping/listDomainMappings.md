...
description: "SOAP API will return all domains for a particular customer. "
date: "2018-02-12"
tags:
    - "method"
    - "sldn"
...
# [REST Example](#listDomainMappings-example) <a href="/article/rest/"><i class="fas fa-question"></i></a> {#listDomainMappings-example .anchor-link} 
```bash
