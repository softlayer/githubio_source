...
<div id="properties" class="content">
    ...
    <div id="method-div">
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_Network_Storage_Allowed_Host/assignSubnetsToAcl'> assignSubnetsToAcl</a> </span>
            ...
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_Network_Storage_Allowed_Host/getAssignedIscsiVolumes'> getAssignedIscsiVolumes</a> </span>
            ...
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_Network_Storage_Allowed_Host/getAssignedNfsVolumes'> getAssignedNfsVolumes</a> </span>
            <div class='views-field-body'>Retrieve the SoftLayer_Network_Storage volumes to which this SoftLayer_Network_Storage_Allowed_Host is allowed access.</div>
        </div>
            <div class="method-row">
            ...
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_Network_Storage_Allowed_Host/getSubnetsInAcl'> getSubnetsInAcl</a> </span>
            <div class='views-field-body'>Retrieve the SoftLayer_Network_Subnet records assigned to the ACL for this allowed host.</div>
        </div>
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_Network_Storage_Allowed_Host/removeSubnetsFromAcl'> removeSubnetsFromAcl</a> </span>
            <div class='views-field-body'></div>
        </div>
            <div class="method-row">
