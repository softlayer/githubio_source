...
# [REST Example](#getTopFiveKnowledgeLayerQuestions-example) <a href="/article/rest/"><i class="fas fa-question"></i></a> {#getTopFiveKnowledgeLayerQuestions-example .anchor-link} 
```bash
