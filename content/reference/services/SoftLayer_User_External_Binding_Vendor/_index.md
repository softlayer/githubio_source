...
<div id="properties" class="content">
    ...
    <div id="method-div">
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_User_External_Binding_Vendor/getAllObjects'> getAllObjects</a> </span>
            <div class='views-field-body'>Get a list of all available external binding vendors that SoftLayer supports.</div>
        </div>
            <div class="method-row">
                        <span class='view-field-title'><a href='/reference/services/SoftLayer_User_External_Binding_Vendor/getObject'> getObject</a> </span>
            <div class='views-field-body'>Retrieve a SoftLayer_User_External_Binding_Vendor record.</div>
        </div>
        </div>
</div>
