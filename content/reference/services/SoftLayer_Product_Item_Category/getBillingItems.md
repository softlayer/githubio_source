...
description: "Retrieve the billing items associated with an account that share a category code with an item category's category code."
layout: "method"
tags:
    - "method"
    - "sldn"
...
aliases:
    - "/reference/services/softlayer_product_item_category/getBillingItems"
---
