...
### [REST Example](#getPMInfo-example) <a href="/article/rest/"><i class="fas fa-question"></i></a> {#getPMInfo-example .anchor-link} 
```bash
curl -g -u $SL_USER:$SL_APIKEY -X GET \
'https://api.softlayer.com/rest/v3.1/SoftLayer_Hardware_SecurityModule750/{SoftLayer_Hardware_SecurityModule750ID}/getPMInfo'
```
