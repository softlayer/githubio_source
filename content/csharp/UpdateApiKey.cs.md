---
title: "UpdateApiKey.cs"
description: "UpdateApiKey.cs"
date: "2017-11-23"
classes: 
...
```
﻿//-----------------------------------------------------------------------
// <copyright file="UpdateApiKey.cs" company="Softlayer">
...
namespace Users
{
    ...
    {
        /// <summary>
        /// This script updates api key for users. 
        ...
        static void Main(string[] args)
        {
            ...
            // Declare the usernames that you wish to update their api keys
            ...
            try
            {
                ...
                foreach (var user in users)
                {
                    ...
                    string newApiKey = customerService.addApiAuthenticationKey();
                    Console.WriteLine("User: " + user.username + " New Api Key: " + newApiKey);
                }
            }
            catch (Exception e)
            {
                Console.WriteLine("Unable to update the Api Key: " + e.Message);
            }
        }
    }
}
