---
title: "get_hardware_list.pl"
description: "get_hardware_list.pl"
date: "2017-11-23"
classes: 
    - "SoftLayer_Search"
    - "SoftLayer_Hardware"
...
# Bar Metal Server
my $filter_data = 'networkGatewayMemberFlag:0 _objectType:SoftLayer_Hardware';

my $result = $client->advancedSearch($filter_data);

if ($result ->fault) {
    die 'Unable to get the Hardware item list. ' . $result ->faultstring;
}
