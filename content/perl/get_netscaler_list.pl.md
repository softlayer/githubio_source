---
title: "get_netscaler_list.pl"
description: "get_netscaler_list.pl"
date: "2017-11-23"
classes: 
...
# when applying the below filter: NetScaler
my $filter_data = '_objectType:SoftLayer_Network_Application_Delivery_Controller';
