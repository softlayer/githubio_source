---
title: "enable_user_can_edit_settings.py"
description: "enable_user_can_edit_settings.py"
date: "2017-11-23"
classes: 
...
try:
    ...
    print("Unable to enable user can edit settings. faultCode=%s, faultString=%s" % (e.faultCode, e.faultString))
