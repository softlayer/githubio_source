---
title: "enable_require_security_questions_on_log_in.py"
description: "enable_require_security_questions_on_log_in.py"
date: "2017-11-23"
classes: 
...
```
"""
Enable require security questions on log in.
...
try:
    ...
    print("Unable to enable require security questions on log in. faultCode=%s, faultString=%s" % (e.faultCode, e.faultString))
