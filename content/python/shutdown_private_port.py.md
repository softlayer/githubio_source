---
title: "shutdown_private_port.py"
description: "shutdown_private_port.py"
date: "2017-11-23"
classes: 
...
try:
    ...
    result = client['Virtual_Guest'].shutdownPrivatePort(id=serverId)
    pp(result)
except SoftLayer.SoftLayerAPIError as e:
        pp('Unable to shutdown the private port faultCode=%s, faultString=%s'
