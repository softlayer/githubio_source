---
title: "place_order_file_storage_endurance_with_snapshot_size.py"
description: "place_order_file_storage_endurance_with_snapshot_size.py"
date: "2017-11-23"
classes: 
...
```
"""
Order a file storage (endurance) with snapshot storage space.
...
# Renember that the values must not exceed the size of the configured storage size.
snapshotSize = "set me"
